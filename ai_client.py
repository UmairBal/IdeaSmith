...
class AIClient:
    ...
    def complete(self, user_prompt: str, system_prompt: str = "", max_tokens: int = 2000) -> str:
        ...
        return method(user_prompt, system_prompt, max_tokens)

    # ── Groq ──────────────────────────────────────────────────────────────────

    def _complete_groq(self, user_prompt: str, system_prompt: str, max_tokens: int) -> str:
    ...
    def _complete_anthropic(self, user_prompt: str, system_prompt: str, max_tokens: int) -> str:
        import anthropic
    ...
    def _complete_openai(self, user_prompt: str, system_prompt: str, max_tokens: int) -> str:
        import openai
    ...
    def _complete_gemini(self, user_prompt: str, system_prompt: str, max_tokens: int) -> str:
    ...
    def _complete_mistral(self, user_prompt: str, system_prompt: str, max_tokens: int) -> str:
    ...
    def _complete_cohere(self, user_prompt: str, system_prompt: str, max_tokens: int) -> str:
        import cohere
        client = cohere.ClientV2(api_key=self.api_key)  # cohere>=5.0.0
        messages = []
        if system_prompt:
            messages.append({"role": "system", "content": system_prompt})
        messages.append({"role": "user", "content": user_prompt})
